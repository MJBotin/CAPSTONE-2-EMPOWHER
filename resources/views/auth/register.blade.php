                    ...
                    <div class="overflow-y-auto p-6">
                        ...
                        <div class="grid grid-cols-1 gap-x-8 gap-y-4 md:grid-cols-2">
                            ...
                            <div class="row-span-3">
                                <label for="photo-upload" id="photo-upload-label" class="relative flex h-full w-full cursor-pointer flex-col items-center justify-center overflow-hidden rounded-lg border-4 border-[#A2C4D9] bg-gray-200 transition hover:bg-gray-300">
                                    <div class="upload-placeholder-content text-center">
                                        <svg class="mx-auto h-10 w-10 text-[#66AABB]" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M3 9a2 2 0 012-2h.93a2 2 0 001.664-.89l.812-1.22A2 2 0 0110.437 4h3.126a2 2 0 011.664.89l.812 1.22A2 2 0 0018.07 7H19a2 2 0 012 2v9a2 2 0 01-2 2H5a2 2 0 01-2-2V9z" /><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M15 13a3 3 0 11-6 0 3 3 0 016 0z" /></svg>
                                        <span class="mt-2 text-sm text-[#00000080]">Upload 1 x 1 Photo <span class="text-[#F01136E6]">*</span></span>
                                    </div>
                                </label>
                ...
                <div class="flex max-h-[90vh] flex-col overflow-hidden rounded-2xl bg-[#F7F2EB]">
                    ...
                    <div class="overflow-y-auto p-6">
                            ...
                            <div class="grid grid-cols-1 gap-x-8 gap-y-4 md:grid-cols-2">
                                <div class="flex flex-col space-y-4">
                                    <div>
                                        ...
                                        <div class="relative">
                                            ...
                                            <input type="tel" name="contact_number" id="contact_number" class="h-10 w-full rounded-md border border-gray-300 py-2 pl-12 pr-3 focus:outline-none focus:ring-0" maxlength="10" inputmode="numeric" required>
                                        </div>
                                    </div>
                                    <div>
                                ...
                                <div class="flex flex-col space-y-4">
                                    <div class="grid grid-cols-2 gap-4">
                                        <label for="id-front-upload" id="id-front-label" class="relative flex h-36 cursor-pointer flex-col items-center justify-center overflow-hidden rounded-lg border-4 border-[#A2C4D9] bg-gray-200 text-center hover:bg-gray-300">
                                            <div class="upload-placeholder-content">
                                                <svg class="mx-auto h-8 w-8 text-[#66AABB]" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="M6.827 6.175A2.31 2.31 0 015.186 7.23c-.38.054-.757.112-1.134.175C2.999 7.58 2.25 8.507 2.25 9.574V18a2.25 2.25 0 002.25 2.25h15A2.25 2.25 0 0021.75 18V9.574c0-1.067-.75-1.994-1.802-2.169a47.865 47.865 0 00-1.134-.175 2.31 2.31 0 01-1.64-1.055l-.822-1.316a2.192 2.192 0 00-1.736-1.039 48.774 48.774 0 00-5.232 0 2.192 2.192 0 00-1.736 1.039l-.821 1.316z" /><path stroke-linecap="round" stroke-linejoin="round" d="M16.5 12.75a4.5 4.5 0 11-9 0 4.5 4.5 0 019 0zM18.75 10.5h.008v.008h-.008V10.5z" /></svg>
                                        ...
                                        <label for="id-back-upload" id="id-back-label" class="relative flex h-36 cursor-pointer flex-col items-center justify-center overflow-hidden rounded-lg border-4 border-[#A2C4D9] bg-gray-200 text-center hover:bg-gray-300">
                                            <div class="upload-placeholder-content">
                                                <svg class="mx-auto h-8 w-8 text-[#66AABB]" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="M6.827 6.175A2.31 2.31 0 015.186 7.23c-.38.054-.757.112-1.134.175C2.999 7.58 2.25 8.507 2.25 9.574V18a2.25 2.25 0 002.25 2.25h15A2.25 2.25 0 0021.75 18V9.574c0-1.067-.75-1.994-1.802-2.169a47.865 47.865 0 00-1.134-.175 2.31 2.31 0 01-1.64-1.055l-.822-1.316a2.192 2.192 0 00-1.736-1.039 48.774 48.774 0 00-5.232 0 2.192 2.192 0 00-1.736 1.039l-.821 1.316z" /><path stroke-linecap="round" stroke-linejoin="round" d="M16.5 12.75a4.5 4.5 0 11-9 0 4.5 4.5 0 019 0zM18.75 10.5h.008v.008h-.008V10.5z" /></svg>
                                ...
                                <div>
                                    ...
                                    <input type="text" name="address" id="address" class="h-10 w-full rounded-md border border-gray-300 px-3 py-2 focus:outline-none focus:ring-0" required>
                                </div>
                            </div>
                        </div>
                        <div class="pt-6">
                            ...
                            <div class="grid grid-cols-1 gap-x-6 gap-y-4 md:grid-cols-3">
                                <div>
                                    ...
                                    <input type="text" name="username" id="username" class="h-10 w-full rounded-md border border-gray-300 px-3 py-2 focus:outline-none focus:ring-0" required>
                                </div>
                                <div>
                                    <label for="password" class="mb-1 block text-sm font-medium text-[#000000]">Password <span class="text-[#F01136E6]">*</span></label>
                                    <input type="password" name="password" id="password" class="h-10 w-full rounded-md border border-gray-300 px-3 py-2 focus:outline-none focus:ring-0" required>
                                </div>
                                <div>
                                    ...
                                    <input type="password" name="password_confirmation" id="password_confirmation" class="h-10 w-full rounded-md border border-gray-300 px-3 py-2 focus:outline-none focus:ring-0" required>
                                </div>
                            </div>
                        ...
                        <div class="mt-6 flex items-center">
                            <input id="agree" name="agree" type="checkbox" class="h-4 w-4 rounded text-[#000000] focus:ring-[#000000]" required>
                    ...
                    <div class="flex shrink-0 justify-end gap-3 p-4">
                        ...
                        <button id="submit-button" type="submit" class="rounded-lg bg-[#239549C7] px-5 py-1.5 text-sm font-semibold uppercase tracking-wide text-[#000000]">SUBMIT REGISTRATION</button>
                    </div>
                </div>
            </div>
        </form>
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        function createImagePreviewHandler(inputId, labelId) {
            ...
            input.addEventListener('change', function (event) {
                ...
                reader.onload = (e) => {
                    const placeholder = label.querySelector('.upload-placeholder-content');
                    ...
                    img.className = 'absolute inset-0 h-full w-full rounded-lg object-cover';
                    label.appendChild(img);
                    
                    label.classList.remove('border-dashed', 'bg-gray-200', 'hover:bg-gray-300', 'items-center', 'justify-center');
        ...
        function validateStep1() {
            const requiredFieldIds = ['last_name', 'first_name', 'photo-upload', 'gender', 'age', 'civil_status', 'dob', 'place_of_birth'];
        ...
        function validateStep2() {
            const requiredFieldIds = ['contact_number', 'id-front-upload', 'id-back-upload', 'address', 'username', 'password', 'password_confirmation'];
            for (const id of requiredFieldIds) {
                 const field = document.getElementById(id);
                 if ((field.type === 'file' && field.files.length === 0) || (field.type !== 'file' && !field.value.trim())) {
        ...
        enforceNumericInput(contactInput);
        enforceNumericInput(ageInput);
    });
</script>
@endsection