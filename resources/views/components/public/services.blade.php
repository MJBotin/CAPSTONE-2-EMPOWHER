        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div class="card shadow-lg rounded-lg p-6 flex flex-col items-center text-center" style="background-color: #de9f98;">
                ...
                <figure class="mb-4 h-40 w-full">
                    <img src="/img/bclearance.png" alt="Barangay Clearance" class="rounded-lg w-full h-full object-cover">
                </figure>
                <p class="text-sm leading-relaxed text-white text-justify">
                    Barangay Clearance certifies that the individual is of good moral character and has no pending cases or obligations within the barangay. It is commonly required for employment, business permits, or other legal and government transactions.
                </p>
            </div>
            ...
            <div class="card shadow-lg rounded-lg text-slate-800 p-6 flex flex-col items-center text-center" style="background-color: #8f94ac;">
                ...
                <figure class="mb-4 h-40 w-full">
                    <img src="/img/bcertificate.png" alt="Barangay Certificate" class="rounded-lg w-full h-full object-cover">
                </figure>
                <p class="text-sm leading-relaxed text-white text-justify">
            ...
            <div class="card shadow-lg rounded-lg text-slate-800 p-6 flex flex-col items-center text-center" style="background-color: #ba9f76;">
                ...
                <figure class="mb-4 h-40 w-full">
                    <img src="/img/indigency.png" alt="Indigency Clearance" class="rounded-lg w-full h-full object-cover">
                </figure>
                <p class="text-sm leading-relaxed text-white text-justify">
                    An Indigency Clearance certifies that a person or family belongs to the low-income sector of the community. This document is often used to access government aid, medical assistance, or educational benefits.
                </p>
            </div>
            ...
            <div class="card shadow-lg rounded-lg text-slate-800 p-6 flex flex-col items-center text-center" style="background-color: #80512c;">
                ...
                <figure class="mb-4 h-40 w-full">
                    <img src="/img/rcertificate.png" alt="Resident Certificate" class="rounded-lg w-full h-full object-cover">
                </figure>
                <p class="text-sm leading-relaxed text-white text-justify">
                    A Resident Certificate verifies that the bearer is a legitimate resident of the barangay. It is typically requested for local transactions, government applications, or other proof-of-address requirements.
                </p>
            </div>
