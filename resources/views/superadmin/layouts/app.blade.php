...
<body class="font-poppins bg-[#FBF6F1] h-screen overflow-hidden">
...
<div class="flex h-screen flex-col">
    <header class="font-barlow bg-[#134573CC] text-[#FFFFFF] flex justify-between items-center px-6 py-3 flex-shrink-0 z-30 shadow-md sticky top-0">
    ...
    <div class="flex flex-2 relative" >
       ...
       md:fixed md:top-20 md:left-0 md:translate-x-0
       peer-checked:translate-x-0 h-screen">
        ...
        <ul>
           ...
           <!-- Dashboard -->
<li class="mb-2">
    <a href="http://127.0.0.1:8000/superadmin/dashboard" class="flex items-center py-2 px-3 rounded-md hover:bg-[#C1D2E1] font-semibold text-white">
        ...
        <span>Dashboard</span>
            ...
            <!-- Users -->
            <li class="mb-2">
                <a href="http://127.0.0.1:8000/superadmin/user" class="flex items-center py-2 px-3 rounded-md hover:bg-[#C1D2E1] font-semibold text-white">
...
<li class="mb-2">
    <a href="#" class="flex items-center py-2 px-3 rounded-md hover:bg-[#C1D2E1] font-semibold text-white">
      ...
      <main class="flex-1 overflow-y-auto md:ml-60 h-screen">
    @yield('content')
</main>
