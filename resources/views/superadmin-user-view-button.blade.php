...
<head>
  ...
  <title>Super Admin User View Profile</title>
...
<div class="grid grid-cols-2 gap-4 items-end">
  ...
  <!-- Map Preview -->
  <div>
    <label class="block text-sm font-semibold mb-1">Map</label>
    <div class="w-full h-24 rounded-md overflow-hidden border border-gray-300">
      <img 
        src="168f04d3-3fe8-4618-a971-85165a1e5d65.png"
        alt="Map Preview"
        class="w-full h-full object-cover">
    </div>
  </div>
      ...
      <!-- Footer buttons -->
      <div class="flex justify-end gap-4 mt-50">
        <button type="button" onclick="closeModal('')" class="bg-[#A2C4D9] hover:bg-gray-400 text-gray-900 px-4 py-1.5 rounded-md text-[10px] font-bold">CLOSE</button>
        <button type="button" onclick="submitRequest('')" class="bg-[#A2C4D9] hover:bg-green-700 gray-900 px-4 py-1.5 rounded-md text-[10px] font-bold">EDIT</button>
      </div>
